...
function ProposalForm(props) {
    ...
    const schema = yup.object().shape({
        ...
        // minRegister: yup.string().required('Please enter your email.'),
        // maxRegister: yup.string().required('Please enter your email.'),
        // description: yup.string().required('Please enter your email.'),
        // typeName: yup.string().required('Please enter your email.'),
        // brandName: yup.string().required('Please enter your email.'),
        // takePlace: yup.string().required('Please enter your email.'),
    });
    const form = useForm({
        defaultValues: {
            title: '',
            ...
            <Box sx={{ display: 'flex', padding: '0 50px', }}>
                <form onSubmit={form.handleSubmit(handleSubmit)} className={classes.form}>
                    <Grid container>
                        ...
                        <Grid item xs={8}>
                            <InputField className={classes.inputtext} name="description" form={form} />
                        </Grid>
                        ...
                        <Grid item xs={8}>
                            <InputEditBioField className={classes.inputtext} name="minRegister" form={form} />
                        </Grid>
